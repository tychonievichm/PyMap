% I got this old code from Marty.  I am not sure who the author is
% The code does not function in moderm MATLAB, but at leasst I can 
% reverse-engineer it to figure out what it was supposed to do when it worked.
...
% If MAP Display exists, update it.  If it does not build it.
	...
	if (dfdisp)
		...
		dfdisp = figure('name','MAP Display');
		figure(dfdisp);
